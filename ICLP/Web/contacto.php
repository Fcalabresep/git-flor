...
$mail->Host = 'smtp.gmail.com'; // ESTE ES EL SERVIDOR DE SMTP. EN GENERAL ES smtp.dominio.com.ar. PREGUNTAR A LA EMPRESA DE HOSTING

$mail->Port = 587; // DEJAR COMO ESTA
...
$mail->Username = 'administracion@iclpsrl.com.ar'; // ES EL MAIL QUE SACARON
$mail->Password = 'iclp123456'; // CONTRASEÑA DEL MAIL

$mail->setFrom('administracion@iclpsrl.com.ar', 'ICLP'); // DEBE TENER EL MAIL PREVIAMENTE CONFIGURADO Y UN NOMBRE QUE ES EL QUE APARECE EN EL FROM

$mail->addAddress('administracion@iclpsrl.com.ar', 'ICLP'); // A QUIEN VA DIRIGIDO EL MAIL. COMO ES PARA NOSOTROS SE PUEDE PONER EL MISMO MAIL QUE SACAMOS U OTRO.
