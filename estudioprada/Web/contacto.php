...
$mail->Username = 'info@estudioprada.com.ar'; // ES EL MAIL QUE SACARON
$mail->Password = 'Isabella10'; // CONTRASEÑA DEL MAIL

$mail->setFrom('info@estudioprada.com.ar', 'Estudio Prada'); // DEBE TENER EL MAIL PREVIAMENTE CONFIGURADO Y UN NOMBRE QUE ES EL QUE APARECE EN EL FROM

$mail->addAddress('florenciacalabresep@gmail.com', 'Estudio Prada'); // A QUIEN VA DIRIGIDO EL MAIL. COMO ES PARA NOSOTROS SE PUEDE PONER EL MISMO MAIL QUE SACAMOS U OTRO.
